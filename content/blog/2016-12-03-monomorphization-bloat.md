...
<aside class="info-callout" aria-labelledby="repost-notice">
  <p id="repost-notice" class="info-callout-title">This is a repost</p>
  <p>The following is a reproduction of a blog post originally shared on my now-defunct blog Suspect Semantics. It was originally published on December 3rd, 2016.</p>
</aside>
