---
title: Open Source and Corporate Influence
taxonomies:
  topics:
    - Open Source
extra:
...
and commonly-held social norms. The [Open Source Initiative]'s ["Open Source
Definition"] was codified in 1998, establishing clearly what qualifies a
project as "open source."

As documented in ["The New Kingmakers" by Stephen O'Grady], developers saw open
source software as an expression of their power as a labor class, an
...
At the same time, exactly as intended, corporations saw the value of adopting
open source software as a way to cut costs. Google, Facebook, and others have
long been open about the enormous value open source software gave them, and how
it enabled them to establish successful products _quickly_ by eliminating
investment in languages, tools, libraries, and systems for which they'd
otherwise have needed to pay.
...
governs. We can use the term here to, by analogy, describe the ability of
...
maintainers" model is that maintainers are generally not legible to
corporations.
...
secure labor, with customers to supply a product or service. What corporations
...
open source maintainers itself.
...
banner of funding open source development. In describing this, it's important
to distinguish _types_ of open source foundations, which I'll do here by
focusing on the United States. In the US, open source foundations are
generally registered as one of two types of entity for tax purposes.

The first, a 501(c)(3), is named for the part of the tax code that defines
tax-exempt non-profits. A 501(c)(3) must exist for an exclusively charitable
purpose, have strict rules on activities they can undertake. The key benefit of
being a 501(c)(3) is the ability to accept donations, which the donator can
deduct from their own taxes. This rule is intended to incentivize investment by
others in support of the 501(c)(3)'s mission by offering a tax benefit.

The second, a 501(c)(6), is also named for a part of the tax code, this one
defining common-interest non-profits. This includes trade foundations,
business leagues, and similar organizations. 501(c)(6)'s primarily draw their
financing from their member organizations, and they exist primarily to serve
the interests of their members.

In the context of open source foundations, we see both of these types
represented. For example, OWASP, the Open Worldwide Application Security
Project, is a 501(c)(3), while the Linux Foundation is a 501(c)(6).

These two types have different affinities for, and relationships with
corporations. Both can and do accept funding from corporate donators; but the
501(c)(6) structure specifically is made to bring in _membership_ in the
foundation itself, which carries with it specific powers to influence the
direction of the foundation, generally specified in any 501(c)(6)'s bylaws.
...
sidesteps this legibility issue: they can pay their own employees to work on
...
open source projects. There is another salient case to consider: corporations
releasing their own first-party open source software. Again, there are many
models for how this release relates to the business of the corporation
...
In fact, we can see this _does_ happen in practice. Recently, researchers
affiliated with GitHub, the Linux Foundation, and Harvard University's
"Laboratory for Innovation Science" released their ["2024 Open Source Software
Funding Report,"][survey_report] which found that among the responding companies
(which collectively contributed $1.7 billion to open source software projects),
86% of their contributions came in the form of contribution labor by employees.
...
As [Ashley Williams identified][ashley] on the Oxide and Friends episode "Open
...
There are _many_ effects to the pervasive accrual of power by corporate open
...
3. Favoring corporate needs in project priorities.
...
produce the software and the users who consume and may contribute back to it.
While maintainers do not _owe_ anything to their users — to quote the popular
MIT license "THE SOFTWARE IS PROVIDED 'AS IS,' WITHOUT WARRANTY OF ANY KIND" —
most maintainers do try to meet an implied social contract of the minimum
expectations of an open source software project.
...
example, in the social engineering campaign against Lasse Collin, maintainer
...
instead of being used to support maintainers. The [Open Source Security
Foundation's][openssf] (OpenSSF's) [Scorecard] tool has at times faced this
...
to, an open source project to [relicense the project away from an open source
license][relicense].
...
These constraints manifest in ways big and small; architectural decisions,
...
and supporting the establish of consultancies by individual maintainers, and
...
faith engagement with open source by corporate contributors.
...
- Any requirement of a Contributor License Agreement for contribution to an
  open source project.
- The use of a permissive open source license for a [single vendor or majority
  single vendor][single-vendor] open source project.
...
on maintainers, greater systemic exposure to relicensing risk, and persistant
...
Thank you to [Ashley Williams][agdubs], [Adam Jacob][adam], and
[Stephen O'Grady][stephen] for reviewing this post and providing feedback prior
to publication. Your inputs were extremely valuable for honing the message
and delivery, and your own speaking and writing on open source software have
been highly influential and informative for me.

## References

1. Christine Peterson, originator of the term "open source." <https://foresight.org/our-team/christine-peterson-co-founder-past-president/>
2. The Open Source Initiative. <https://opensource.org/about>
3. The Open Source Definition. <https://opensource.org/osd>
4. "The New Kingmakers" by Stephen O'Grady. <https://thenewkingmakers.com/>
5. The Heartbleed vulnerability. <https://en.wikipedia.org/wiki/Heartbleed>
6. "Seeing Like a State" by James C. Scott. <https://yalebooks.yale.edu/book/9780300078152/seeing-like-a-state/>
7. Tidelift. <https://tidelift.com/>
8. "I'm Now a Full-Time Professional Open Source Maintainer" by Filippo Valsorda. <https://words.filippo.io/full-time-maintainer/>
9. "Acquired: The Mark Zuckerberg Interview" <https://www.acquired.fm/episodes/the-mark-zuckerberg-interview>
10. "2024 Open Source Software Funding Report," by Sam Boysel, et. al. <https://opensourcefundingsurvey2024.com/>
10. "The Tyranny of Structurelessness" by Jo Freeman. <https://www.jofreeman.com/joreen/tyranny.htm>
11. Ashley Williams on structurelessness and open source, Oxide and Friends, Season 3, Episode 15: "Open Source Governance." <https://oxide.computer/podcasts/oxide-and-friends/1367163>
11. The Open Source Security Foundation. <https://openssf.org/>
12. OpenSSF Scorecard. <https://scorecard.dev/>
13. "Open Source Foundations Considered Helpful" by James Governor. <https://redmonk.com/jgovernor/2024/09/13/open-source-foundations-considered-helpful/>
14. "Platform as a Reflection of Values" by Bryan Cantrill. <https://www.youtube.com/watch?v=Xhx970_JKX4>
15. "Why Single-Vendor is the New Proprietary" by Thierry Carrez. <https://opensource.net/why-single-vendor-is-the-new-proprietary/>
...
[survey_report]: https://opensourcefundingsurvey2024.com/
...
[agdubs]: https://x.com/ag_dubs
[adam]: https://x.com/adamhjk
[stephen]: https://redmonk.com/team/stephen-ogrady/
